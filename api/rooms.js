...
async function handleRoom(req, res) {
  ...
  if (body.action === "create") {
    ...
    await touch({
      ...
      hostGeneration: String(body.hostGeneration || cur.hostGeneration || "").slice(0, 40),
      hostAge: body.hostAge != null && body.hostAge !== "" ? body.hostAge : (cur.hostAge ?? ""),
      hostAgeBracket: String(body.hostAgeBracket || cur.hostAgeBracket || "").slice(0, 8),
