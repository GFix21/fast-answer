 ...
 * is collected from a child under 13. A profile under the country age is
 * not stored from the child's own form. A profile aged 18 or older can add
 * that player. That parent lock is not an identity-document check.
