...
/** Age wins when the seat has a bracket. Otherwise the stored generation stands. */
...
export function packSummary(packs) {
  ...
  return { target: PACK_TARGET, counts, ages, sendsFor, year: AGE_REFERENCE_YEAR, held };
}
