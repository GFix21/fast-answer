 ...
 * The password stays in GMAIL_PASSWORD (or GMAIL_APP_PASSWORD). It is never written into the repo.
 * On Vercel this sender is only used when GMG_LIST_ORIGIN=off. Otherwise GMG Brand sends the letter.
 */
