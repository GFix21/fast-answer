import { reviewForChildren } from "./safeguard.js";

/**
 * Crack'd Kerr reviews funny questions already in the bank.
 * Each week the bot reads the new funny questions and the highest-scoring
 * ones, and names a short viral set. It does not copy jokes from outside
 * the bank. A question Safeguard rejects is not rated and is not viral.
 */
